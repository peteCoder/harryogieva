  ...
  return (
    <section className="bg-white py-10 px-6 text-center">
      <div className="max-w-8xl mx-auto">
        ...
        <ScrollReveal>
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-[2px] text-[#3a2e25] mb-4">
        ...
        <ScrollReveal>
          <p className="text-[#5c4f3a] max-w-4xl mx-auto leading-relaxed text-[15px]">
            Looking to buy or sell? With my deep understanding of the real
            estate landscape across Lagos, Abuja, Benin City, and beyond, I
            offer you access to properties that align with your goals. Together,
            we will navigate the market with confidence, ensuring you make
            informed, strategic decisions that lead to success.
          </p>
        </ScrollReveal>
